...
export class Sprite9Ball extends Renderable {
    constructor(container, position, radius) {
        ...
        topMask.arc(0, 0, radius, PI / 6, 5 * PI / 6);
        const bottomMask = new Path2D();
        bottomMask.arc(0, 0, radius, 7 * PI / 6, 11 * PI / 6);
...
export class Sprite11Ball extends Renderable {
    constructor(container, position, radius) {
        ...
        this.addPath(new RenderablePath2D(bottomMask, DrawType.Fill, Color.White, Color.White));
        this.addPath(new RenderablePath2D(numberBkg, DrawType.Fill | DrawType.Stroke, Color.DarkGray, Color.White));
        this.addPath(new RenderableText("11", { x: -6, y: 7 }, DrawTextType.Fill, "20px Arial", Color.Black));
    }
}
export class Sprite12Ball extends Renderable {
    constructor(container, position, radius) {
        ...
        this.addPath(new RenderablePath2D(bottomMask, DrawType.Fill, Color.White, Color.White));
        this.addPath(new RenderablePath2D(numberBkg, DrawType.Fill | DrawType.Stroke, Color.DarkGray, Color.White));
        this.addPath(new RenderableText("12", { x: -6, y: 7 }, DrawTextType.Fill, "20px Arial", Color.Black));
    }
}
export class Sprite13Ball extends Renderable {
    constructor(container, position, radius) {
        ...
        this.addPath(new RenderablePath2D(bottomMask, DrawType.Fill, Color.White, Color.White));
        this.addPath(new RenderablePath2D(numberBkg, DrawType.Fill | DrawType.Stroke, Color.DarkGray, Color.White));
        this.addPath(new RenderableText("13", { x: -6, y: 7 }, DrawTextType.Fill, "20px Arial", Color.Black));
    }
}
export class Sprite14Ball extends Renderable {
    constructor(container, position, radius) {
        ...
        this.addPath(new RenderablePath2D(bottomMask, DrawType.Fill, Color.White, Color.White));
        this.addPath(new RenderablePath2D(numberBkg, DrawType.Fill | DrawType.Stroke, Color.DarkGray, Color.White));
        this.addPath(new RenderableText("14", { x: -6, y: 7 }, DrawTextType.Fill, "20px Arial", Color.Black));
    }
}
export class Sprite15Ball extends Renderable {
    constructor(container, position, radius) {
        ...
        this.addPath(new RenderablePath2D(bottomMask, DrawType.Fill, Color.White, Color.White));
        this.addPath(new RenderablePath2D(numberBkg, DrawType.Fill | DrawType.Stroke, Color.DarkGray, Color.White));
        this.addPath(new RenderableText("15", { x: -6, y: 7 }, DrawTextType.Fill, "20px Arial", Color.Black));
    }
}
